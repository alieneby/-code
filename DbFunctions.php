<?php
    if ( ! function_exists( 'dbQuery' ) && ! empty ( Config::$_DB_DB ) ) {
         ...
         * @param string $strQuery
         * @param int|mysqli $linkID
         * @param int $resultType (optional) Possible values are MYSQLI_ASSOC, MYSQLI_NUM, or MYSQLI_BOTH
         ...
         * @param string $strQuery
         * @param string $strColSep
         * @param string $strRowSep
         * @return string Result of SQL
         */
